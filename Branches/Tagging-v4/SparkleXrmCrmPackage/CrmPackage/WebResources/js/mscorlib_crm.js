...
scriptLoader.load("mscorlib", null, function () {
    ...
    */
    ...
    //CG CHANGE!
    if (typeof String.__typeName === 'undefined') {
    ...
    */
        ...
        Type.registerNamespace = function Type$registerNamespace(name) {
            ...
            for (var i = 0; i < nameParts.length; i++) {
                ...
                if (!nso) {
                    ...
                    if (i === 0) {
                        //CG CHANGE!
                        window.__rootNamespaces.push(nso);
                    }
                }
                ns = nso;
            }
    ...
    //CG CHANGE!
    if (typeof Type.prototype.initializeBase === 'undefined') {
    ...
    */
    ...
    //CG CHANGE
    if (typeof Type.prototype.getInterfaces === 'undefined') {
    ...
    //CG CHANGE CONT!
    if (typeof Type.prototype.isInstanceOfType === 'undefined') {
