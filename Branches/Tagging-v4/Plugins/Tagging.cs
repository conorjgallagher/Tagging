...
namespace Tagging.Plugins
{
    [CrmPluginRegistration("Update", "xrmc_taggingconfiguration",
        ...
        "xrmc_termsandconditionsversion,xrmc_licensekey", "TaggingManagement", 1, IsolationModeEnum.Sandbox,
    ...
    public class Tagging : IPlugin
    {
        ...
        public void Execute(IServiceProvider serviceProvider)
        {
            ...
            var cols = new ColumnSet("xrmc_termsandconditionsversion");
            ...
            try
            {
                ...
                //validation for only one configuration record can be created
